...
MOST_COMMON_ENGLISH_WORDS_LOWERCASE = ["the", "of", "to", "and", "a", "in", "is", "it", "you", "that", "he", "was",
                                       "for", "on", "from", "or", "were", "which", "write", "are", "with", "as", "i",
                                       "his", "they", "be", "at", "one", "have", "this", "had", "by", "not", "word",
                                       "but", "what", "some", "we", "can", "out", "other", "all", "there", "when", "up",
                                       "use", "your", "how", "said", "an", "each", "she", "do", "their", "time", "if",
                                       "will", "way", "about", "many", "then", "them", "would", "like", "so", "these",
                                       ...
                                       "state", "keep", "eye", "never", "last", "let", "easy", "thought", "city",
                                       "tree", "cross", "farm", "hard", "might", "story", "saw", "far", "sea", "draw",
                                       ...
                                       "six", "table", "travel", "less", "morning", "ten", "simple", "several", "vowel",
                                       ...
                                       "plane", "stead", "dry", "wonder", "laugh", "thousand", "ago", "ran", "check",
                                       "game", "shape", "equate", "hot", "miss", "brought", "heat", "snow", "tire",
                                       "bring", "yes", "distant", "fill", "east", "paint", "language", "among", "grand",
                                       "ball", "yet", "wave", "drop", "heart", "am", "present", "heavy", "dance",
                                       "engine", "position", "arm", "wide", "sail", "material", "random", "size",
                                       "vary", "settle", "speak", "weight", "matter", "circle", "pair", "include",
                                       "divide", "syllable", "felt", "perhaps", "pick", "sudden", "count", "square",
                                       "reason", "length", "represent", "art", "subject", "region", "energy", "hunt",
                                       "probable", "bed", "brother", "egg", "ride", "cell", "believe", "fraction",
                                       "forest", "sit", "race", "window", "store", "summer", "train", "sleep", "prove",
                                       "lone", "leg", "exercise", "wall", "catch", "mount", "wish", "sky", "board",
                                       "joy", "winter", "sat", "written", "beatles", "wild", "instrument", "kept",
                                       "glass", "job", "edge", "sign", "visit", "past", "soft", "fun", "bright", "gas",
                                       "weather", "month", "million", "bear", "finish", "happy", "hope", "flower",
                                       "clothe", "strange", "gone", "jump", "baby", "eight", "village", "meet", "root",
                                       "buy", "raise", "solve", "metal", "whether", "push", "seven", "paragraph",
                                       "third", "shall", "held", "hair", "describe", "cook", "floor", "either",
                                       "result", "burn", "hill", "safe", "cat", "century", "consider", "type", "law",
                                       "bit", "coast", "copy", "phrase", "silent", "tall", "sand", "soil", "roll",
                                       "temperature", "finger", "industry", "value", "fight", "lie", "beat", "excite",
                                       "natural", "view", "sense", "ear", "else", "quite", "broke", "case", "middle",
                                       "kill", "son", "lake", "moment", "scale", "loud", "spring", "observe", "child",
                                       ...
                                       "below", "key", "iron", "single", "stick", "flat", "twenty", "smile", "crease",
                                       "hole", "trade", "melody", "trip", "office", "receive", "row", "mouth", "exact",
                                       "symbol", "die", "least", "trouble", "shout", "except", "wrote", "seed", "tone",
                                       "join", "suggest", "clean", "break", "brute", "lady", "yard", "rise", "bad",
                                       "blow", "oil", "touch", "grew", "cent", "mix", "team", "wire", "cost", "lost",
                                       "brown", "wear", "garden", "equal", "sent", "choose", "fell", "fit", "flow",
                                       "fair", "bank", "collect", "save", "control", "decimal", "gentle", "woman",
                                       "captain", "practice", "separate", "difficult", "doctor", "please", "protect",
                                       "noon", "whose", "locate", "ring", "character", "insect", "caught", "period",
                                       ...
                                       "won't", "chair", "danger", "fruit", "hell", "rich", "thick", "soldier",
                                       "process", "operate", "necessary", "sharp", "wing", "create", "neighbor", "wash",
                                       ...
                                       "dead", "spot", "desert", "suit", "current", "lift", "rose", "continue", "block",
                                       "chart", "hat", "sell", "success", "company", "subtract", "event", "particular",
                                       ...
                                       "solution", "magnet", "silver", "thank", "branch", "match", "suffix",
                                       ...
                                       "task", "glad", "original", "share", "station", "dad", "charge", "ice", "proper",
                                       "bar", "offer", "heaven", "segment", "slave", "duck", "instant", "degree",
                                       "populate", "chick", "dear", "enemy", "reply", "drink", "occur", "support",
                                       "speech", "nature", "range", "steam", "motion", "path", "liquid", "log", "meant",
                                       "quotient", "teeth", "general", "market", "shell", "blood", "bread", "neck",
                                       "grass", "guess", "skin", "start", "cow"]
